...
all: sha2.o CPU.o SHA256.o Block.o Blockchain.o main.o
	g++ $(BUILD_DIR)/sha2.o $(BUILD_DIR)/CPU.o $(BUILD_DIR)/SHA256.o $(BUILD_DIR)/Block.o $(BUILD_DIR)/Blockchain.o $(BUILD_DIR)/main.o -o $(BUILD_DIR)/$(TARGET)
	make clean
